...
class NoteVC: UIViewController {
    ...
    private func fetchNotes()
    {
        ...
        do{
            ...
            for item in items
            {
                notesArray.append(item.lastPathComponent) // last path component means /documents/roshan.txt where roshan.txt is last path component
            }
    ...
    override func viewDidLoad() {
        ...
        let logoutbtn = UIBarButtonItem(barButtonSystemItem: .done, target: self, action: #selector(logout))
